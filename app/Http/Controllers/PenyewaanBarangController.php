...
class PenyewaanBarangController extends Controller
{
    ...
    public function index()
    {
        $penyewaan = TransaksiPenyewaan::with(['user', 'barang', 'penyewaan'])
            ->whereHas('penyewaan', function ($query) {
                $query->where('status_penyewaan', 'Dipinjam');
            })
            ->get()
            ->groupBy('penyewaan.id');

        return view('admin.penyewaan.penyewaan', compact('penyewaan'));
    }
    ...
    public function create()
    {
        $users = User::all();
        $barang = Barang::all();
        return view('admin.penyewaan.tambah_penyewaan', compact('users', 'barang'));
    }
    ...
    public function confirm()
    {
        $penyewaan = TransaksiPenyewaan::with(['user', 'barang', 'penyewaan'])
            ->whereHas('penyewaan', function ($query) {
                $query->where('status_penyewaan', 'Menunggu Konfirmasi');
            })
            ->get()
            ->groupBy('penyewaan.id');

        return view('admin.penyewaan.konfirmasi_penyewaan', compact('penyewaan'));
    }
    ...
    public function riwayat()
    {
        ...
        return view('admin.penyewaan.riwayat_penyewaan', compact('penyewaan'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'status_penyewaan' => 'required|in:Dipinjam,Dikembalikan,Menunggu konfirmasi',
    ...
    public function kembali($id)
    {
        ...
        return redirect()->route('penyewaan.index')->with('success', 'Status penyewaan berhasil diubah menjadi Dikembalikan');
    }
}