...
<div class="container pt-3 pb-3">
    ...
    <a href="{{ route('penyewaan.create') }}" class="btn btn-primary mb-3">Tambah Penyewaan</a>
        ...
        <tbody>
            @foreach($penyewaan as $penyewaanGroup)
                ...
                <tr>
                    ...
                    <td>{{ $firstPenyewaan->user->nama_lengkap }}</td>
                    ...
                    <td>
                        @if($firstPenyewaan->penyewaan->status_penyewaan !== 'Dikembalikan')
                            <form action="{{ route('penyewaan.kembali', $firstPenyewaan->penyewaan->id) }}" method="POST" style="display:inline-block;">
                                @csrf
                                @method('PATCH')
